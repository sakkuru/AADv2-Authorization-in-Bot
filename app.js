...
const WEBSITE_HOSTNAME = process.env.WEBSITE_HOSTNAME0;
const PORT = process.env.port || process.env.PORT || 3998;
...
console.log('env:', WEBSITE_HOSTNAME, PORT, BOTAUTH_SECRET, MICROSOFT_APP_ID, MICROSOFT_APP_PASSWORD, AZUREAD_APP_ID, AZUREAD_APP_PASSWORD, AZUREAD_APP_REALM);
...
// Create chat bot
console.log(MICROSOFT_APP_ID, MICROSOFT_APP_PASSWORD);
